...
const useTagsViewStore = defineStore('tags-view', {
  state: () => ({
    visitedViews: JSON.parse(sessionStorage.getItem('visitedViews') || '[]') as View[],
    cachedViews: JSON.parse(sessionStorage.getItem('cachedViews') || '[]') as string[],
    iframeViews: [] as View[],
  }),
  ...
  actions: {
    ...
    addCachedView(view: any) {
      ...
      sessionStorage.setItem('cachedViews', JSON.stringify(this.cachedViews));
    },
    ...
    // 更新标签顺序
    updateViewOrder(newOrder: View[]) {
      this.visitedViews = newOrder;
      sessionStorage.setItem('visitedViews', JSON.stringify(this.visitedViews));
    },
  },
});
